...
<htmllang="en-US">
    <head>
        ...
        <style type="text/css">
            ...
            .slider .clearfix li:nth-child(2){
            background-color: #eb0837;
            }
          .slider .clearfix li:nth-child(3){
            background-color: #67b374;
            }    
           .slider .clearfix li:nth-child(4){
            background-color: #e6674a;
            }    
            .slider .clearfix li:nth-child(5){
